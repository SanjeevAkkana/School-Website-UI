...
const Admissions = () => {
  return (
    <div className="text-black pt-28 container mx-auto px-4">
      <div className="relative">
        ...
        <div className="absolute w-64 h-64 bg-blue-50 z-[-10] rounded-full left-0 top-1/2 transform -translate-y-1/2 blur-3xl"></div>
